...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">Blockon | Employee </span>
                        </div>
          ...
          <div class="footer">
                   <p class="copyright">All rights reserved<a href="http://blockon.tech/">Blockon.tech </a>©</p>
                </div>
                </div>
            </aside>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Blockon</h4></div>
